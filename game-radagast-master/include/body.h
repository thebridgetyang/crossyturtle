...
list_t *body_get_shape_dev(body_t *body);
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @return the image passed to body_init()
 */
...
void body_set_image(body_t *body, SDL_Surface *img);

void body_set_info(body_t *body, void *inf);
